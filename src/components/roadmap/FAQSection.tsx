...
const faqs = [
  {
    ...
    answer:
      "€3.000 es exactamente lo que cobras por un proyecto que te lleva 3 meses de revisiones infinitas con un cliente que te regateó hasta el alma. Ese es el problema. Este programa son 3 meses para montar tu sistema completo. Con UN solo cierre de €10.000-€15.000 ya recuperaste la inversión. No dos. No cinco. Uno. La pregunta real no es si te lo puedes permitir. Es cuántos meses más te puedes permitir seguir cobrando €1.500 por brandings que valen €8.000.",
  },
  {
