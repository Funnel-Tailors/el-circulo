...
const CircleHero = () => {
  ...
  return <div className="text-center space-y-8 mb-8 animate-fade-in -mt-8">
      ...
      {/* Subtítulo */}
      <p className="text-2xl md:text-3xl font-display font-bold text-foreground leading-[1em] glow max-w-2xl mx-auto px-4">El secreto que descubrí para vender proyectos de 5 cifras a gente que puede pagarlas (y no te da la chapa )</p>
