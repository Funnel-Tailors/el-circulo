  ...
  return (
    <section ref={ref} className="relative py-24">
      <div className="max-w-4xl mx-auto px-6">
        <div className="glass-card-dark p-12 relative overflow-hidden">
          ...
          <div className="space-y-8">
            {[
              ...
              <div
                key={index}
                className={`relative pl-6 border-l-2 border-foreground/20 transition-all duration-700 hover:border-foreground/40 ${
              ...
              >
                <div className="absolute left-0 top-0 w-0.5 h-full bg-foreground/40 animate-pulse" 
            ...
            <div 
              className={`mt-16 pt-8 border-t border-accent/20 transition-all duration-1000 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
