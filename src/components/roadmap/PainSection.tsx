...
export const PainSection = () => {
  ...
  const painParagraphs = [
    ...
    <>Es que te pasas semanas creando contenido, marca personal, un portfolio que no mira ni dios, <span className="font-bold italic glow text-foreground">mientras los miembros del Círculo</span> tienen ejecutado el sistema en 5 días — y optimizado por completo en menos de 7.</>,
